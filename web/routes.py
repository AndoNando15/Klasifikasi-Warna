...
def predict():
    ...
    accuracy_by_label = {label: {"correct": 0, "total": 0} for label in label_map.values()}
    ...
    summary = {
        ...
        "label_accuracy": {
            label: {
                ...
                "total": data["total"],
                "accuracy": round((data["correct"] / data["total"]) * 100, 2) if data["total"] else 0.0
            }
    ...
    return render_template("result.html", predictions=predictions, summary=summary, model_info=model_info)
